...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var str3 = a + ' and ' + b + ' and ' + c + ' sum to ' + sum3 + '.';
  var str4 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multiply3 + '.';

  return [sum3, multiply3, str3, str4];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  for (var i = 0; i < multArr.length; i ++){
    arrayMultiply = multiply(multArr[i], arrayMultiply)[0];
  }
  return[arrayMultiply, 'The numbers ' + testArray + ' have a product of ' + arrayMultiply+ '.'];
}
